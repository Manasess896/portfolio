...
function logVisitorToMongoDB()
{
    ...
    if (!empty($_SESSION['visited_log_done_projects'])) {
        return;
    }
    $_SESSION['visited_log_done_projects'] = true;
    ...
    <div class="container main-document">
        <header class="d-flex flex-wrap justify-content-between align-items-center py-4 mb-5 border-bottom">
            ...
            <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
                ...
                <li><a href="" class="nav-link px-3 text-dark">Projects</a></li>
            </ul>
        </header>
    ...
    <script>
        const projectsData = {
            'whatsapp-bot': {
                ...
                links: [{
                        text: "Try Bot",
                        url: "https://wa.me/+254106159887"
                    },
                    {
                        text: "View Code",
                        url: "https://github.com/Manasess896/advanced-ai-whatsapp-bot"
                    }
                ],
                iframe: null
            },
            'php-auth': {
                ...
                links: [{
                    text: "View Code",
                    url: "https://github.com/Manasess896/PHP-AUTHENTICATON-SYSTEM"
                }],
                iframe: null
            },
            'bouquets': {
                ...
                links: [{
                        text: "View Live",
                        url: "https://bouquetsbylynn.onrender.com"
                    },
                    {
                        text: "View Code",
                        url: "https://github.com/Manasess896/Bouquetsbylynn"
                    }
                ],
            ...
            'just-share': {
                ...
                links: [{
                    text: "View Live",
                    url: "https://just-share-arac.onrender.com/"
                }],
            ...
            'watchlist': {
                ...
                links: [{
                    text: "View Live",
                    url: "https://showtrackr.manases.space/contact-us"
                }],
            ...
            'tmdb-explorer': {
                ...
                links: [{
                    text: "View Live",
                    url: "https://tmdb-explorer-7dc5031211d9.herokuapp.com/"
                }],
            ...
            'whatsapp-otp': {
                ...
                links: [{
                    text: "View Code",
                    url: "https://github.com/Manasess896/otp-verification-using-whatsapp"
                }],
                iframe: null
            },
            'x-bot': {
                ...
                links: [{
                    text: "View Code",
                    url: "https://github.com/Manasess896/X-bot"
                }],
                iframe: null
            },
            'weather': {
                ...
                links: [{
                    text: "View Live",
                    url: "https://weather1-0.onrender.com/"
                }],
            ...
            'lime-vtc': {
                ...
                links: [{
                        text: "View Live",
                        url: "https://lime-g8zh.onrender.com"
                    },
                    {
                        text: "View Code",
                        url: "https://github.com/Manasess896/LIME"
                    }
                ],
            ...
            'school-template': {
                ...
                links: [{
                        text: "View Live",
                        url: "https://school-website-template-18iy.onrender.com"
                    },
                    {
                        text: "View Code",
                        url: "https://github.com/Manasess896/school-website-template"
                    }
                ],
